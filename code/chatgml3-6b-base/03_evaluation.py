...
def setup_logging():
    """配置日志系统：同时输出到控制台和文件"""
    log_dir = "../results/logs/03_evaluation"
...
# ===================== 核心配置 =====================
INPUT_DATA_PATH = "../results/new_chatgml/01.20inference_results/inference_results_allcon.json"
OUTPUT_EVAL_DIR = "../results/new_chatgml/01.20evaluation_reports"
os.makedirs(OUTPUT_EVAL_DIR, exist_ok=True)
OUTPUT_EVAL_PATH = os.path.join(OUTPUT_EVAL_DIR, "evaluation_report_chatgml3.json")
